...
$field->setNotice('Meta Infos eines Artikels z.B. <code>yrewrite_description</code>. Durch Zeilenschaltung getrennt. Wenn der Artikelname in die Übersetzung mit aufgenommen werden soll, so kann dieser mit der Angabe <code>name</code> mit aufgenommen werden. Wenn der Kategoriename mit übersetzt werden soll, so kann dieser mit der Angabe <code>catname</code> aufgenommen werden.');
